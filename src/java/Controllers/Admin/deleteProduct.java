...
public class deleteProduct extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (product != null) {
                int resultOrderDetail = productDao.deleteProductDetail(Integer.parseInt(productId));
                
                int result = productDao.deleteProductByid(Integer.parseInt(productId));
            }
        } catch (Exception ex) {
            Logger.getLogger(deleteProduct.class.getName()).log(Level.SEVERE, null, ex);
        }
        response.sendRedirect("productIndex");
    }
