...
public class searchByPrice extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String paramPrice = request.getParameter("news");
        String[] price = paramPrice.split("-");
        try {
            listProducts = productDAO.searchProductByPice(price[0], price[1]);
            categories = categoryDao.getAllCategory();
            ArrayList<Product> listProductTop5 = productDAO.getProductTopNew();

            request.setAttribute("listProductPage", listProducts);
